...
class SalesPredictorLight:
    def __init__(self, model_dir: str = "models"):
        self.model_dir = model_dir
        os.makedirs(model_dir, exist_ok=True)
        
        self.models: Dict[Tuple[str, str], RandomForestRegressor] = {}
    ...
    def _save_models(self):
        ...
        with open(os.path.join(self.model_dir, "sales_predictor_light.pkl"), "wb") as f:
            pickle.dump(model_data, f)
    
    def load_models(self):
        model_path = os.path.join(self.model_dir, "sales_predictor_light.pkl")
